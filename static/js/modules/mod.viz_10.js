	...
	fn = {
		...
		message_added: function(message){
			...
			message.marker = new google.maps.Marker({
					icon: new google.maps.MarkerImage('static/img/dot_32.png', new google.maps.Size(32, 32)),
					position: new google.maps.LatLng(message.lat_lng[0], message.lat_lng[1])
			});
