var ImageOverlay = L.Class.extend({
...
var CssOverlay = L.Class.extend({
	...
	onAdd: function (map) {
		this._map = map;
		this._el = L.DomUtil.create('div', 'balloon leaflet-zoom-hide');
		this._el.style.background = this._message.color;
		// this._el.style.background = 'url(static/img/dot.png) transparent';
		this._el.style.position = 'absolute';
		this._el.style.display = 'block';
		this._el.style.width = "32px";
		this._el.style.height = "32px";
